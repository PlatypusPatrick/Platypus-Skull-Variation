...
#Allometry with individual Sex as an interaction
Allom_Sex_M <-procD.lm(shape~size*sex(c("Male"), iter = 499, data = AllometryGDF)
summary(Allom_Sex_M)

Allom_Sex_F <-procD.lm(shape~size*sex(c("Male"), iter = 499, data = AllometryGDF)
summary(Allom_Sex_F)

Allom_Sex_NA <-procD.lm(shape~size*sex(!Male), iter = 499, data = AllometryGDF)
summary(Allom_Sex_NA)
