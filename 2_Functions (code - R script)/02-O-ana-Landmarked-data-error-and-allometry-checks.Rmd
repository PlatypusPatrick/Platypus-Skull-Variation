...
#Allometry analyses POTENTIALLY DELETE IN FAVOUR OF BELOW
```{r}
...
par(mfrow=c(1,2))
#PlotAllometry doesnt't work but the alternativbe from teh helpfile does
...
#Work on below when above works
...
plotAllometry(Allom_Sex, size = AllometryGDF$size, logsz = TRUE, method = "RegScore", pch = 19)


plotAllometry(Allom_Sex, size=AllometryGDF$size,  cex=0.5, pch = 16, col= grp.col, logsz=FALSE, method="RegScore")

plot(Allom_Sex, size=AllometryGDF$size, , xlab = "Centroid size", ylab= "Regression Score", cex=0.5, pch = 16, col= grp.col)
...
## LATITUDE
#Allometry with Latitude as an interaction
