...
#The below should not give NAs if the names of one data frame are present in the other
...
#Making sure bY.shape and meta.info$Csize match up; they don't seem to!
dimnames(bY.shape)[[3]]
rownames(meta.info)
