...
meanspec <- findMeanSpec(AllometryGDF$shape)

Mean_spec <- read.ply("../1_Data (original data)/1_Raw/O_ana_QVM_M1986x1x47.ply")
Mean_spec$material$color <- Mean_spec$it
Mean_spec$material$color <- "purple"
...
colour_pca_sex <- c("Black", "Red", "Blue")
...
plot(x = pca_general$pc.scores[, 1],
                         ...
                         col = grp_col_pca_sex, 
                         pch = 16 )
legend("topleft", levels(meta.info$Sex), col=colour_pca_sex, pch = 19)
