...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
UP TO HERE
Problem - merging sp.info and metadata give 50obs not 74obs

Once fixed, will have to figure out how to add sex, lat and pop into Allom 
...
Allom_Sex <-procD.allometry(shape~size, iter = 499, data = shape.size, sex.x)
summary(Allom_Sex)
...
CS_Sex <- procD.pgls(Shape ~CS, iter = 499, data = shape.size) #example code from Ariel's work
Summary(CS_Sex)
