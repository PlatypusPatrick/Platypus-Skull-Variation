...
#Allometry (same as above but checking with added AllometryGDF - Should give same results)
...
#Allometry with sex as an interaction
Allom_Sex <-procD.lm(shape~size*sex, iter = 499, data = AllometryGDF)
summary(Allom_Sex)

#Allometry with Sex as a linear model
Allom_Sex <-procD.lm(shape~size+sex, iter = 499, data = AllometryGDF)
summary(Allom_Sex) 
#Practally the same result for sex under all three tests (>0.001 diference - still significant)
