...
#Plot
plot(Allom_Sex_MF_NoInter, type = "regression", reg.type = "RegScore", predictor = AllometryGDF_MF$size, pch = 19)
```
...
Allom_Pop <-procD.lm(shape~pop, iter = 499, data = AllometryGDF_Pop)
summary(Allom_Pop)
```
...
Allom_Pop_MT <-procD.lm(shape~pop, iter = 499, data = AllometryGDF_MT)
...
Allom_Pop_MWV <-procD.lm(shape~pop, iter = 499, data = AllometryGDF_MWV)
